...
(defun nano-theme ()
  ...
  (let ((dark '((background dark))))
   ...
   `(marginalia-date                        ((t (:foreground ,frost-2))))
   ...
   `(marginalia-file-priv-dir               ((t (:foreground ,frost-2))))
   `(marginalia-file-priv-exec              ((t (:foreground ,aurora-3))))
   ...
   `(marginalia-file-priv-read              ((t (:foreground ,aurora-2))))
   `(marginalia-file-priv-write             ((t (:foreground ,aurora-0))))
   ...
   `(marginalia-size                        ((t (:foreground ,aurora-3))))
